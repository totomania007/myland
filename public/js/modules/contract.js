...
export function renderContractView() {
  ...
  if (document.getElementById('c-lessee-name-1')) document.getElementById('c-lessee-name-1').innerText = state.currentTenant.fullName || 'ผู้เช่า';
  if (document.getElementById('c-lessee-age-1')) document.getElementById('c-lessee-age-1').innerText = state.currentTenant.age || '-';
  if (document.getElementById('c-lessee-address-1')) document.getElementById('c-lessee-address-1').innerText = state.currentTenant.address || '-';
  ...
  if (document.getElementById('c-duration-1')) document.getElementById('c-duration-1').innerText = state.currentTenant.duration || '1';

  if (state.currentTenant.startDate) {
    const sD = new Date(state.currentTenant.startDate);
  ...
  if (document.getElementById('sig-lessee-1')) document.getElementById('sig-lessee-1').innerText = state.currentTenant.fullName || 'ผู้เช่า';

  if (document.getElementById('c-card-img-1')) document.getElementById('c-card-img-1').src = state.currentTenant.imageUrl || CONFIG.PLACEHOLDER_SVG;
